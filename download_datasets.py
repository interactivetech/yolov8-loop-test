...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset-dir', default='/run/determined/workdir/shared_fs/andrew-demo-revamp/', help='path to checkpoint')
    parser.add_argument('--key', default='/run/determined/workdir/shared_fs/andrew-demo-revamp/', help='path to checkpoint')
    ...
    dataset = project.version(2).download("yolov8",location=os.path.join(args.dataset_dir,"x-ray-rheumatology"))
    ...
    dataset = project.version(2).download("yolov8",location=os.path.join(args.dataset_dir,"flir-camera-objects"))
